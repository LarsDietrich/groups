...
class CreateGroupController extends Zend_Controller_Action
{
    protected $_form;
    protected $_namespace = 'CreateGroupController';
    protected $_session;
    
    public function getForm() {
        if (null === $this->_form) {
            $this->_form = new Application_Form_CreateGroup('', array('disableLoadDefaultDecorators' => true));
        }
        return $this->_form;
    }
    ...
    public function getNextSubForm()
    {
        ...
        Zend_Debug::dump($storedForms, '<strong>Stored Forms: </strong>');
        
        $potentialForms = $this->getPotentialForms();
        
        Zend_Debug::dump($potentialForms, '<strong>Potential Forms: </strong>');
    ...
    public function indexAction()
    {
        ...
        Zend_Debug::dump($form, '<strong>indexAction Form: </strong>');
